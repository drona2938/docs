...
<Steps>
  ...
  <Step title="Step 2">
    2\. On the Functions page, click the **`Add `**&#x42;utton.
  </Step>
</Steps>
...
<Tip>
  **Name**
  ...
  The best practice is to Name your Function in a way that it allows you, and others, to know exactly what it does at first sight. For example, instead of using “weather” as a name, use “get\_current\_weather”.&#x20;
