...
<Info>
  ...
  Fliqr AI has included a pre-configured trigger that allows the user to stop bot automation and talk with a human agent. This Function is already active on all accounts {version} & this is name {projectName}.
</Info>
